...
var controller = {
    ...
    updateProject(req, res){
        ...
        Project.findByIdAndUpdate(projectId, update, {new: true}, (err, projectUpdated)=>{
            if(err) return res.status(500).send({message: 'Error al actualizxar'});
    ...
    deleteProject(req, res){
        ...
        Project.findByIdAndRemove(projectId, (err, projectRemoved)=>{
            ...
            if(!projectRemoved) return res.status(404).send({message: "Tiene que introducir un proyecto a eliminar"});
